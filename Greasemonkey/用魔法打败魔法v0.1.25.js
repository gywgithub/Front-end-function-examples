...
(async function () {
  ...
  function getContinueFlag() {
    ...
    const userPortalID = loginCookieObj["userPortal"]['portalID']
    const eid = loginCookieObj["eid"]
    const userid = loginCookieObj["userid"]

    console.log('---')
    console.log("token:", token);
    console.log('userPortalID: ', userPortalID)
    console.log('eid: ', eid)
    ...
    return new Promise((resolve, reject) => {
       ...
       */
      fetch(
        `https://api.moxueyuan.com/c45814c9a643ea71new2/appapi.php/index
          ?r=apiMy/getMyStudyCount
          &version=6.0.0
          &platform=pcweb
          &eid=${eid}
          &userid=${userid}

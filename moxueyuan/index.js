...
// @version      0.1.24
// @description  自动播放，切换视频，自动点击弹框
// @author       Mr_Jiang, Mr_Guo
// @match        *://*/*
...
(async function () {
  ...
  function getContinueFlag() {
    ...
    return new Promise((resolve, reject) => {
      fetch(
        "https://api.moxueyuan.com/c45814c9a643ea71new2/appapi.php/index?r=apiMy/getMyStudyCount&version=6.0.0&platform=pcweb&eid=25415&userid=d342c421_821a_c554_c7b8_8f4da4ef61f5&token=248cd8996838335cc3c0bc0da48937fc&language=zh_CN&userPortalID=389&type=m&start_time=1680278400&end_time=1682870399",
        requestOptions
      )
  ...
  setInterval(function () {
    ...
    const vedio = document.querySelectorAll("#player_html5_api")[0];
    const doc = document.querySelectorAll('.course_doc')[0]
    if (!vedio && doc) {
      // doc
    ...
    // // 每隔1分钟获取一下焦点（刷新时间）- 无效
    // document.querySelectorAll("#domScroll")[0].focus();
    ...
    // setTimeout(() => {
    //   console.log("点击视频区，防止倒计时停止"); // 手动触发的点击，获取焦点 - 无效
    //   document.querySelectorAll("#player-box")[0].click();
    //   document.querySelectorAll("#player")[0].click();
    // }, 200);
  ...
  //   document.querySelectorAll("#player_html5_api")[0].currentTime = 1;
  // }, 1000 * 60 * 10);
  ...
  function del() {
    ...
    // const pb2 = document.getElementsByClassName("popup-buttons")[0];
    // if (pb2) {
    //   pb2.click();
    // }
  }
